...
namespace IDCM.ControlMBL.Module
{
    class LibFieldBuilder
    {
        ...
        protected void loadTemplates(){
            customTCDList = CustomTColDefDAM.loadCustomAll();
            string templatePath = ConfigurationManager.AppSettings["CTableTemplate"];
            templDict = CTableSetting.getTableTemplateDef(templatePath);
        ...
        public void submitCustomSetting()
        {
            ...
            {
                UpdateTemplateHandler uth = new UpdateTemplateHandler(customTCDList);
                CmdConsole.call(uth, CmdConsole.CmdReqOption.L);
            }
        }
